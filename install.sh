...
ln -s /etc/init.d/php-fpm56 /etc/init.d/php-fpm
#\cp ./php/switch_php_version.sh   /etc/switch_php_version.sh 
#chmod 755  /etc/switch_php_version.sh 

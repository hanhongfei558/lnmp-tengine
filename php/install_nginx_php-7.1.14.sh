...
PHP_DIR=/alidata/server/php-7.1.14
...
make install
cd ..
cp ./php-7.1.14/php.ini-production $PHP_DIR/etc/php.ini
#adjust php.ini
...
install -v -m755 ./php-7.1.14/sapi/fpm/init.d.php-fpm  /etc/init.d/php-fpm
